...
@NgModule({
  declarations: [AdminContainerComponent, UsuarioComponent, ProductoComponent, CategoriaComponent, DesarrolloComponent, NoticiaComponent, QuieneComponent, PedidoComponent, ComentarioComponent, VentaComponent, PreguntaComponent],
  imports: [
    CommonModule,
    AdminRoutingModule,
    MatTabsModule,
